...
module tb_ALU_Regfile;
    ...
    initial begin
        ...
        run_case(rv32_i(12'hfff,             5'd0, 3'b000, 5'd15, OPCODE_OP_IMM), 5'd15, 32'hffff_ffff, "ADDI x15, x0, -1");
        run_case(rv32_i(12'd0,               5'd0, 3'b000, 5'd16, OPCODE_OP_IMM), 5'd16, 32'd0,         "ADDI x16, x0, 0");
        run_case(rv32_i(12'd1,               5'd0, 3'b000, 5'd17, OPCODE_OP_IMM), 5'd17, 32'd1,         "ADDI x17, x0, 1");
        run_case(rv32_i(12'h800,             5'd0, 3'b000, 5'd18, OPCODE_OP_IMM), 5'd18, 32'hffff_f800, "ADDI x18, x0, -2048");
        ...
        run_case(rv32_i(12'd0,               5'd15,3'b010, 5'd26, OPCODE_OP_IMM), 5'd26, 32'd1, "SLTI  x26, x15, 0");
        run_case(rv32_i(12'd0,               5'd15,3'b011, 5'd27, OPCODE_OP_IMM), 5'd27, 32'd0, "SLTIU x27, x15, 0");
        run_case(rv32_i(12'hfff,             5'd16,3'b010, 5'd28, OPCODE_OP_IMM), 5'd28, 32'd0, "SLTI  x28, x16, -1");
        run_case(rv32_i(12'hfff,             5'd16,3'b011, 5'd29, OPCODE_OP_IMM), 5'd29, 32'd1, "SLTIU x29, x16, -1");
        run_case(rv32_i(12'hfff,             5'd17,3'b010, 5'd30, OPCODE_OP_IMM), 5'd30, 32'd0, "SLTI  x30, x17, -1");
        run_case(rv32_i(12'hfff,             5'd17,3'b011, 5'd31, OPCODE_OP_IMM), 5'd31, 32'd1, "SLTIU x31, x17, -1");
        run_case(rv32_i(12'h800,             5'd18,3'b010, 5'd5,  OPCODE_OP_IMM), 5'd5,  32'd0, "SLTI  x5,  x18, -2048");
        run_case(rv32_i(12'h800,             5'd18,3'b011, 5'd6,  OPCODE_OP_IMM), 5'd6,  32'd0, "SLTIU x6,  x18, -2048");
        run_case(rv32_i(12'hfff,             5'd18,3'b010, 5'd7,  OPCODE_OP_IMM), 5'd7,  32'd1, "SLTI  x7,  x18, -1");
        run_case(rv32_i(12'hfff,             5'd18,3'b011, 5'd8,  OPCODE_OP_IMM), 5'd8,  32'd1, "SLTIU x8,  x18, -1");
        run_case(rv32_i(12'h800,             5'd15,3'b010, 5'd9,  OPCODE_OP_IMM), 5'd9,  32'd0, "SLTI  x9,  x15, -2048");
        run_case(rv32_i(12'h800,             5'd15,3'b011, 5'd10, OPCODE_OP_IMM), 5'd10, 32'd0, "SLTIU x10, x15, -2048");
