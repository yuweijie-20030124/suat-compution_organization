...
module SUAT_idu(
	...
	,output    wire [2:0]  			wbu_op
	,output    wire [4:0]           lsu_op
...
wire type_store = (opcode[6:2] == `SUAT_STORE) & (opcode[1:0] == 2'b11)     ;
...
//output to wb signal
assign wbu_op[2] = type_load;
assign wbu_op[1] = rd_wen & ~type_load;
assign wbu_op[0] = rd_wen;

//-------------------------------output--------------------------//

// output to exu
assign data1 = rs1_data & {32{type_r | type_i | type_branch}} | snpc & {32{jump}};
assign data2 = rs2_data & {32{type_r | type_branch | type_store}} | imm & {32{type_i}};
assign data3 = rs1_data & {32{inst_jalr | type_load | type_store}} | pc & {32{type_branch | inst_auipc | inst_jal}};
assign data4 = imm & {32{type_branch | jump | inst_auipc | inst_lui | type_load | type_store}};

assign lsu_op = {inst_lbu, inst_lb, inst_lw, inst_sb, inst_sw};

assign exu_op[17] = jump;
assign exu_op[16] = inst_bge | inst_bgeu;
assign exu_op[15] = inst_bne;
assign exu_op[14] = inst_beq;
assign exu_op[13] = inst_blt | inst_bltu;
assign exu_op[12] = type_branch | jump;
assign exu_op[11] = inst_lui | inst_auipc;
assign exu_op[10] = type_r | type_i | jump | type_store;
assign exu_op[9]  = inst_sltu | inst_slt | inst_sltiu | inst_slti;
assign exu_op[8]  = inst_xor | inst_xori;
assign exu_op[7]  = inst_or | inst_ori | jump | type_store;
assign exu_op[6]  = inst_and | inst_andi;
assign exu_op[5]  = inst_sltu | inst_slt | inst_sub | inst_sltiu |
	inst_slti | type_branch;
assign exu_op[4]  = inst_sltu | inst_sltiu | inst_bltu | inst_bgeu;
assign exu_op[3]  = inst_add | inst_sub | inst_addi;
