...
module tb_ALU_Regfile;
    ...
    initial begin
        ...
        run_case(rv32_u(20'h12345,           5'd15, OPCODE_LUI),            5'd15, 32'h1234_5000,                 "LUI x15, 0x12345");
        run_case(rv32_u(20'h00010,           5'd16, OPCODE_AUIPC),          5'd16, tb_pc + 32'h0001_0000,         "AUIPC x16, 0x00010");
        run_case(rv32_j(21'd8,               5'd17, OPCODE_JAL),            5'd17, tb_pc + 32'd4,                 "JAL x17, 8");
        run_case(rv32_i(12'd12,              5'd1, 3'b000, 5'd18, OPCODE_JALR),    5'd18, tb_pc + 32'd4,                 "JALR x18, x1, 12");
